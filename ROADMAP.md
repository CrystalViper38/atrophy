...
The same instrument could also serve the research itself: today's studies measure cognitive
offloading once, in the lab, on a few hundred people. atrophy measures it continuously, in the
field, and could extend that measurement to a far larger cohort.
